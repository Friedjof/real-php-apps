...
<table border="0" cellpadding="0" cellspacing="0">
 ...
 <tr><td style="text-align:center;padding:4px;background-color:#d0cdd0;">Wählen Sie eine Farbe aus der Palette<br>bzw. 'transparent' bzw.<br> tragen Sie je einen Wert zwischen<br>0...255 für Rot, Grün und Blau ein<br>und mischen Sie Ihre Wunschfarbe!</td></tr>
 <tr><td>&nbsp;</td></tr>
 <tr>
  <td align="center">
   <table border="0" cellpadding="3" cellspacing="1">
    ...
    <tr bgcolor="#ffffff"><td>Grün:</td><td><input type="text" name="g" value="<?php if($Col!='transparent') echo hexdec(substr($Col,3,2));?>" size="10"></td></tr>

...
Bitte rufen Sie jetzt unbedingt den Men�punkt <a href="konfSetup.php"><img src="<?php echo $sIcon?>" width="12" height="13" border="0" alt="Setup ausf�hren"></a>
...
jedoch ist die Variablen- und Einstelldatei <i>kalWerte.php</i> noch auf dem fr�heren Stand <?php echo KAL_Version?>.
Bitte rufen Sie jetzt unbedingt den Men�punkt <a href="konfUpdate.php"><img src="<?php echo $sIcon?>" width="12" height="13" border="0" alt="Update einpflegen"></a>
<a href="konfUpdate.php" title="Update">Update</a> auf, um die erneuerte Version endg�ltig einzupflegen.</div><br />
...
F�r registrierte Lizenznehmer ist Version <?php echo $sNewVer?> verf�gbar.
Bitte informieren Sie sich, ob diese Version f�r Sie <a href="https://<?php echo $sHost?>/version3.html" target="_blank">n�tzliche Neuerungen</a> enth�lt.</div><br />
<?php }?>

<p class="admMeld">�berblick zur Datenstatistik</p>
<?php
 ...
 }else echo '<p class="admFehl">MySQL-Datenbank nicht ge�ffnet!</p>';
?>
...
<td><?php echo $nT?> ver�ffentlichte Termine in <i><?php echo (!KAL_SQL?KAL_Termine:KAL_SqlTabT)?></i></td>
</tr><tr class="admTabl">
...
<td class="admSpa1" style="width:14em"><a href="terminLoeschung.php" title="l�schen"><img src="<?php echo $sIcon?>" width="12" height="13" border="0" alt="bearbeiten"></a> Terminliste</td>
<td><?php echo $nD?> zu l�schende Termine in <i><?php echo (!KAL_SQL?KAL_Termine:KAL_SqlTabT)?></i></td>
</tr><tr class="admTabl">
...
<td><?php echo $nM?> Adressen f�r Erinnerungen/Benachrichtigungen in <i><?php echo (!KAL_SQL?KAL_MailAdr:KAL_SqlTabM)?></i></td>
</tr><tr class="admTabl">
...
<td><?php echo $nE?> Erinnerungsw�nsche zu anstehenden Terminen in <i><?php echo (!KAL_SQL?KAL_Erinner:KAL_SqlTabE)?></i></td>
</tr><tr class="admTabl">
...
<td><?php echo $nB?> Benachrichtigungsw�nsche zu Termin�nderungen in <i><?php echo (!KAL_SQL?KAL_Benachr:KAL_SqlTabB)?></i></td>
...
<table class="admTabl" border="0" cellpadding="2" cellspacing="1">
<tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="konfAllgemein.php" title="bearbeiten"><img src="<?php echo $sIcon?>" width="12" height="13" border="0" alt="bearbeiten"></a> Geheimschl�ssel</td>
<td><?php echo KAL_Schluessel?> - Niemals ver�ndern!<div class="admMini">(Nur notieren f�r eine eventuelle Neuinstallation des Programms bei vorhandenen Daten.)</div></td>
</tr><tr class="admTabl">
...
<td>tempor�re Dateien l�schen, falls die regelm��ige automatische L�schung Reste hinterlassen hat</td>
</tr><tr class="admTabl">
...
zur Administration eingeschaltet und verwenden ausdr�cklich nicht
...
Falls Ihnen diese ungesch�tzte Datei als Sicherheitsrisiko erscheint,
so l�schen Sie die Datei bitte.</p><?php }?>
</div>

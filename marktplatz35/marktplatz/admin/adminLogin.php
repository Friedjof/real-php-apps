...
if($_SERVER['REQUEST_METHOD']=='POST'){
 if(isset($_POST['login'])){
  ...
  if(strtolower($sName)==AM_Admin&&$sPass==fMpDeCode(AM_Passwort)){//Zugangsdaten OK
...
<div class="admBox">
<p style="text-align:left;"><u>Hinweis</u>: Sie haben momentan den scriptbasierten Zugangsschutz

...
echo fSeitenKopf('Fragen suchen','','UFs');
...
echo '<p class="admMeld">'.(!$bCh?'Stellen Sie Ihre Suchanfrage für Fragen zusammen!':'Verändern Sie Ihre Suchanfrage für Fragen!').'</p>';
$sOptU=''; for($i=1;$i<=26;$i++) $sOptU.='<option value="'.chr($i+64).'">Umfrage '.chr($i+64).'</option>';
?>

<form name="fraEingabe" action="fragenListe.php" method="get">

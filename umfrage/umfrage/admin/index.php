...
<p class="admMeld">Umfrage-Script-Administration - <?php echo (KONF<=0?'Grundkonfiguration':'Konfiguration-'.KONF) ?> - Version <?php $umfVersion='???'; @include(UMFPFAD.'umfVersion.php'); echo trim(substr($umfVersion,0,3)).' ('.trim(substr($umfVersion,4).')');?></p>
...
<a href="konfSetup.php" title="Setup">Setup</a> auf, um das Programm einzurichten. Die Pfadangaben erscheinen momentan nicht schlüssig.</div><br />
...
Bitte rufen Sie jetzt unbedingt den Menüpunkt <a href="konfUpdate.php"><img src="iconAendern.gif" width="12" height="13" border="0" alt="Update einpflegen"></a>
...
<table class="admTabl" border="0" cellpadding="2" cellspacing="1">
<tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="fragenListe.php?kal_Onl=1&amp;kal_Ofl=0&amp;kal_Vmk=0<?php if(KONF>0)echo'&konf='.KONF?>" title="bearbeiten"><img src="iconAendern.gif" width="12" height="13" border="0" alt="bearbeiten"></a> Fragenliste</td>
<td><?php echo $nF?> eingetragene Fragen in <i><?php echo(!UMF_SQL?UMF_Fragen:UMF_SqlTabF)?></i></td>
</tr><tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="ergebnisListe.php<?php if(KONF>0)echo'?konf='.KONF?>" title="anzeigen"><img src="iconAendern.gif" width="12" height="13" border="0" alt="bearbeiten"></a> Ergebnisliste</td>
<td><?php echo $nE?> dazugehörige Ergebnisse in <i><?php echo(!UMF_SQL?UMF_Ergebnis:UMF_SqlTabE)?></i></td>
</tr><tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="nutzerListe.php<?php if(KONF>0)echo'?konf='.KONF?>" title="anzeigen"><img src="iconAendern.gif" width="12" height="13" border="0" alt="bearbeiten"></a> Benutzerliste</td>
<td><?php echo $nN?> registrierte Benutzer in <i><?php echo(!UMF_SQL?UMF_Nutzer:UMF_SqlTabN)?></i></td>
</tr><tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="teilnahmeListe.php<?php if(KONF>0)echo'?konf='.KONF?>" title="bearbeiten"><img src="iconAendern.gif" width="12" height="13" border="0" alt="bearbeiten"></a> Teilnahmeliste</td>
<td><?php echo $nT?> eingetragene Teilnahmen in <i><?php echo(!UMF_SQL?UMF_Teilnahme:UMF_SqlTabT)?></i></td>
</tr><tr class="admTabl">
<td class="admSpa1" style="width:14em"><a href="konfDaten.php<?php if(KONF>0)echo'?konf='.KONF?>"><img src="iconAendern.gif" width="12" height="13" border="0" alt="bearbeiten"></a> Datenbasis</td>

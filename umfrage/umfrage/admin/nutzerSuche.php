...
$sMeld='';
$aFlds=explode(';',UMF_NutzerFelder); $nFlds=count($aFlds); for($i=2;$i<$nFlds;$i++) $aFlds[$i]=str_replace('´,',';',$aFlds[$i]);
...
<table class="admTabl" border="0" cellpadding="3" cellspacing="1">
 ...
 <tr class="admTabl">
  <td style="width:34%">Benutzername wie <input type="text" name="n12" value="<?php echo $N12?>" style="width:97%;" /></td>
  <td style="width:33%">oder wie <input type="text" name="n22" value="<?php echo $N22?>" style="width:97%;" /></td>
  <td style="width:33%">aber nicht wie <input type="text" name="n32" value="<?php echo $N32?>" style="width:97%;" /></td>
 </tr>
<?php
 for($i=4;$i<$nFlds;$i++){
 ...
 echo '
 <tr class="admTabl">
  <td style="width:34%">'.($aFlds[$i]!='GUELTIG_BIS'?$aFlds[$i]:(UMF_TxNutzerFrist>''?UMF_TxNutzerFrist:$aFlds[$i])).' wie <input type="text" name="n1'.$i.'" value="'.$N1.'" style="width:97%;" /></td>
  <td style="width:33%">oder wie <input type="text" name="n2'.$i.'" value="'.$N2.'" style="width:97%;" /></td>
  <td style="width:33%">aber nicht wie <input type="text" name="n3'.$i.'" value="'.$N3.'" style="width:97%;" /></td>
 </tr>';
 }
?>
 ...
 <tr class="admTabl">
  <td colspan="3" align="center">suchen in &nbsp;
   <input class="admRadio" type="radio" name="rbForm" value="1" checked="checked" /> Benutzerliste <?php if(UMF_NutzerUmfragen){ ?> &nbsp; oder in &nbsp;
   <input class="admRadio" type="radio" name="rbForm" value="2" /> Benutzer &amp; Umfragen<?php }?>
  </td>
 </tr>
</table>
<div align="center">
